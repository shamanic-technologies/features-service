...
describe("STATS_REGISTRY", () => {
  it("contains recipient stats keys", () => {
  ...
  it("contains recipient reply aggregate keys", () => {
  ...
  it("contains derived recipient rate keys", () => {
  ...
  it("does not contain old email-prefixed keys", () => {
    ...
    expect(VALID_STATS_KEYS.has("costPerOpenCents")).toBe(false);
  });
});
