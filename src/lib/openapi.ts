...
registry.registerPath({
  ...
  responses: {
    ...
    400: { description: "Missing brandId, an unrecognised goal / funnel / pricing value, an unrecognised leg (reason='leg_unrecognised'), a leg sent beside a funnel (reason='leg_and_funnel'), or an unrecognised maximize value (reason='maximize_unrecognised')", content: { "application/json": { schema: errorResponse } } },
