...
export const SEED_FEATURES: SeedFeature[] = [
  {
    ...
    outputs: [
      ...
      { key: "companiesServed", displayOrder: 10 },
      { key: "companiesContacted", displayOrder: 11 },
      { key: "companiesSent", displayOrder: 12 },
      { key: "companiesDelivered", displayOrder: 13 },
      { key: "companiesOpened", displayOrder: 14 },
      { key: "companiesClicked", displayOrder: 15 },
      { key: "companiesBounced", displayOrder: 16 },
      { key: "companiesRepliesPositive", displayOrder: 17 },
      { key: "companiesRepliesNegative", displayOrder: 18 },
      { key: "companiesRepliesNeutral", displayOrder: 19 },
      { key: "leadPositiveReplyRate", displayOrder: 20 },
      { key: "leadClickRate", displayOrder: 21 },
      { key: "costPerLeadClickCents", displayOrder: 22 },
      { key: "costPerLeadPositiveReplyCents", defaultSort: true, displayOrder: 23, sortDirection: "asc" },
    ],
    charts: [
