...
export const SEED_FEATURES: SeedFeature[] = [
  {
    ...
    outputs: [
      ...
      { key: "emailsContacted", displayOrder: 3 },
      { key: "emailsSent", displayOrder: 4 },
      { key: "emailsOpened", displayOrder: 5 },
      { key: "emailsClicked", displayOrder: 6 },
      ...
      { key: "clickRate", displayOrder: 11 },
      { key: "costPerClickCents", displayOrder: 12 },
      { key: "costPerPositiveReplyCents", defaultSort: true, displayOrder: 13, sortDirection: "asc" },
    ],
    charts: [
      { key: "funnel", type: "funnel-bar", title: "Campaign Funnel", displayOrder: 1, steps: [{ key: "leadsServed" }, { key: "emailsGenerated" }, { key: "emailsContacted" }, { key: "emailsSent" }, { key: "emailsOpened" }, { key: "emailsClicked" }, { key: "repliesPositive" }] },
      { key: "replyBreakdown", type: "breakdown-bar", title: "Reply Breakdown", displayOrder: 2, segments: [{ key: "repliesPositive", color: "green", sentiment: "positive" }, { key: "repliesNeutral", color: "gray", sentiment: "neutral" }, { key: "repliesNegative", color: "red", sentiment: "negative" }, { key: "repliesAutoReply", color: "orange", sentiment: "neutral" }] },
    ],
    entities: [
...

  {
    ...
    outputs: [
      ...
      { key: "costPerPositiveReplyCents", defaultSort: true, displayOrder: 12, sortDirection: "asc" },
    ],
    charts: [
      { key: "funnel", type: "funnel-bar", title: "Outreach Funnel", displayOrder: 1, steps: [{ key: "outletsDiscovered" }, { key: "journalistsContacted" }, { key: "emailsGenerated" }, { key: "emailsSent" }, { key: "emailsOpened" }, { key: "repliesPositive" }] },
      { key: "replyBreakdown", type: "breakdown-bar", title: "Reply Breakdown", displayOrder: 2, segments: [{ key: "repliesPositive", color: "green", sentiment: "positive" }, { key: "repliesNeutral", color: "gray", sentiment: "neutral" }, { key: "repliesNegative", color: "red", sentiment: "negative" }, { key: "repliesAutoReply", color: "orange", sentiment: "neutral" }] },
    ],
    entities: [
