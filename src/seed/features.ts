...
export const SEED_FEATURES: UpsertFeatureBody[] = [
  // ─── Sales Cold Email Outreach ──────────────────────────────────────────
  {
    ...
    outputs: [
      ...
      { key: "costPerRecipientPositiveReplyCents", displayOrder: 13, defaultSort: true, sortDirection: "asc" },
    ],
    ...
    charts: [
      {
        ...
        steps: [
          ...
          { key: "recipientsClicked" },
          { key: "recipientsRepliesPositive" },
        ],
      },
      {
        key: "replyBreakdown",
  ...
  // ─── PR Cold Email Outreach ─────────────────────────────────────────────
  {
    ...
    outputs: [
      ...
      { key: "recipientPositiveReplyRate",        displayOrder: 9 },
      { key: "costPerRecipientPositiveReplyCents", displayOrder: 10, defaultSort: true, sortDirection: "asc" },
    ],
  ...
  // ─── PR Cold Email Outreach Sophia (fork) ────────────────────────────────
  {
    ...
    outputs: [
      ...
      { key: "recipientsOpened",            displayOrder: 4 },
      { key: "recipientOpenRate",                displayOrder: 5 },
      { key: "costPerRecipientOpenCents",        displayOrder: 6 },
      { key: "recipientsRepliesPositive",          displayOrder: 7 },
      { key: "recipientsRepliesNegative",          displayOrder: 8 },
      { key: "recipientsRepliesNeutral",           displayOrder: 9 },
      { key: "recipientPositiveReplyRate",        displayOrder: 10 },
      { key: "costPerRecipientPositiveReplyCents", displayOrder: 11, defaultSort: true, sortDirection: "asc" },
    ],
